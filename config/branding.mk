...
PRODUCT_BUILD_PROP_OVERRIDES += BUILD_VERSION_TAGS=release-keys USER=android-build BUILD_ID=OPM2.171019.029.B1 BUILD_DISPLAY_ID=OPM2.171019.029.B1 BUILD_UTC_DATE=$(shell date +"%s")

# Versioning System
NEPHILIM_BASE_VERSION = v3.3
