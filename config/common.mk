...
bootanimation_sizes := $(subst .zip,, $(shell ls vendor/nephilim/extras/bootanimation))
...
PRODUCT_COPY_FILES += \
    vendor/nephilim/extras/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
endif
