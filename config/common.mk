...
bootanimation_sizes := $(subst .zip,, $(shell ls vendor/aicp/extras/bootanimation))
...
PRODUCT_COPY_FILES += \
    vendor/aicp/extras/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
endif
