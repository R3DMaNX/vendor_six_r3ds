...
ADDONSU_INSTALL_TARGET := $(PRODUCT_OUT)/addonsu-$(SIX_VERSION_MAJOR).$(SIX_VERSION_MINOR)-$(TARGET_ARCH).zip
...
ADDONSU_REMOVE_TARGET := $(PRODUCT_OUT)/addonsu-remove-$(SIX_VERSION_MAJOR).$(SIX_VERSION_MINOR)-$(TARGET_ARCH).zip
